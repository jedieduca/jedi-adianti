...
class FormAluno extends TPage
{
    ...
    function __construct()
    {
		...
		$turma = new TDBCombo('idTurma','platia','OfertaTurma','id','denominacao', 'denominacao', $criteria);
        $turma->setSize('30%');*/
        ...
        $escola = new TDBCombo('id_escola', 'platia', 'Colegio', 'id', 'nome', 'nome', $criteriaEscola);
        $escola->setSize('30%');
    ...
    function onEdit($param)
    {
        ...
        try
        {
            if (isset($param['key']))
            {
                ...
                $objAlunoTurma = OfertaTurmaAluno::getAluno($object->id);
                $object->idTurma = $objAlunoTurma->idofertaturma; 
