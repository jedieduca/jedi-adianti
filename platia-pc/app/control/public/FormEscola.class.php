...
class FormEscola extends TPage
{
    ...
    function __construct()
    {
        ...
        $instanciaGestora  = new TDBCombo('idinstanciagestora','platia','InstanciaGestora','id','nome');
        //$marcoReferencial  = new TDBCombo('ismarcoreferencial','platia','MarcoReferencial','id','titulo');
        $municipio  = new TDBCombo('idmunicipio','platia','Municipio','id','nome');
        //$zonaLocalizacao  = new TDBCombo('zonalocalizacao','memore','Local','id','descricao');
