 ...
 */
class FormHabilidadeComputacaoList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('HabilidadeComputacao');   // defines the active record
        parent::setDefaultOrder('id', 'asc');         // defines the default order
        parent::addFilterField('id', '=', 'id'); // filterField, operator, formField
        parent::addFilterField('descricao', 'like', 'descricao'); // filterField, operator, formField
    
        // creates the form
        $this->form = new BootstrapFormBuilder('form_habilidade_computacao_list');
        $this->form->setFormTitle('Habilidades de Computação');
        ...
        $this->form->addAction(_t('New'),  new TAction(array('FormHabilidadeComputacao', 'onEdit')), 'fa:plus green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('FormHabilidadeComputacao', 'onEdit'));
