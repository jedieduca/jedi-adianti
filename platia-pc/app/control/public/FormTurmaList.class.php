...
class FormTurmaList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $id         = new TEntry('id');
        $escola     = new TDBCombo('idescola','platia','Colegio','id','nome');
        $serie      = new TDBCombo('idserieescolar','platia','SerieEscolar','id','descricao');
        ...
        $this->form->addAction(_t('New'),  new TAction(array('FormTurma', 'onEdit')), 'fa:plus blue');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('FormTurma', 'onEdit'));
