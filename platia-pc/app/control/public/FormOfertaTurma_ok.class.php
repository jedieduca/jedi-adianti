...
class FormOfertaTurma extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        $this->userList= new TDBCheckGroup('user_list', 'platia', 'SystemUser', 'id','name','name',$criteria);
        ...
        */
        ...
        TDBCheckGroup::reloadFromModel('form_oferta_turma', 'user_list', 'platia', 'SystemUser', 'id', 'name', 'name');
