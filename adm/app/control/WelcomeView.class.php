...
class WelcomeView extends TPage
{
    ...
    function __construct()
    {
        ...
        //$panel1 = new TPanelGroup('Welcome to the Educational Games register!');
        //$panel1->add($html1);
        
        $panel2 = new TPanelGroup('Bem-vindo ao Módulo de Configuração (Backoffice) do JEDi Educa!');
        $panel2->add($html2);
		
        //$panel3 = new TPanelGroup('¡Bienvenido al registro de Juegos Educativos!');
        //$panel3->add($html3);
