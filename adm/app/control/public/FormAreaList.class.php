 ...
 */
class FormAreaList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('Area');   // defines the active record
        parent::setDefaultOrder('id', 'asc');         // defines the default order
        parent::addFilterField('id', '=', 'id'); // filterField, operator, formField
        parent::addFilterField('descricao', 'like', 'descricao'); // filterField, operator, formField
    
        // creates the form
        $this->form = new BootstrapFormBuilder('form_area_list');
        ...
        $this->form->addAction(_t('New'),  new TAction(array('FormArea', 'onEdit')), 'fa:plus green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('FormArea', 'onEdit'));
