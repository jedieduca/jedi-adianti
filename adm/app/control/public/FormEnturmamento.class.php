...
class FormEnturmamento extends TPage
{
    private $form;
    public $ofertaId;
    public $itens;
    ...
    public function __construct($param)
    {
        ...
        $this->form = new BootstrapFormBuilder('form_enturmamento');
    ...
    {
        echo '<pre>'; print_r(TSession::getValue('idTurma')); echo '</pre>';
        try
        {
            ...
            $id_turma=TSession::getValue('idTurma');
            TurmaAluno::RemoveAlunos($id_turma);
            ...
            if (!empty($vetAlunos))
            {
                foreach ($vetAlunos as $aluno)
                {
                    ...
                    $object->id_aluno  = $aluno;
                    $object->id_turma = $id_turma;
                    $object->store();
