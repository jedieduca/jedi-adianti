...
class FormAluno extends TPage
{
    ...
    function __construct()
    {
        ...
        $criteria=Turma::TurmaAno(date("Y"));
		$turma = new TDBCombo('idTurma','jedieduca','Turma','id','identificacao', 'identificacao', $criteria);
        $turma->setSize('30%');
    ...
    function onEdit($param)
    {
        ...
        try
        {
            if (isset($param['key']))
            {
                ...
                // instantiates object AlunoTurma
                $objAlunoTurma = AlunoTurma::getTurma($object->cpf);
                $object->idTurma = $objAlunoTurma->idTurma;
