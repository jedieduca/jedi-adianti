...
class SystemUser extends TRecord
{
   ...
   /**
    ...
    /**
     * Return the user' instancia's
     * @return Collection of InstanciaGestora
     */
    ...
    /**
     * Return the docente disciplina(s)
     * @return Collection of DocenteDisciplina
     */
    public function getSystemDocenteDisciplina()
    { 
        return parent::loadAggregate('Disciplina', 'DocenteDisciplina', 'iddocente', 'iddisciplina', $this->id);
    }
     ...
     * @param $login String with user login
     */
    static public function newFromUserId($userId)
    {
