...
class ClassProfileView extends TStandardList
{
    ...
    */
    public function __construct()
    {
        ...
        parent::setActiveRecord('ClassProfile');                 // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_ClassProfile');
        $this->form->setFormTitle(_t('Class Profiles'));

        // create the form fields
        $id     = new TEntry('id');
        $escola = new TDBCombo('escola', 'jedi', 'ClassProfile', 'escola', 'escola');
        $turma  = new TDBCombo('turma', 'jedi', 'ClassProfile', 'turma', 'turma');
        ...
        $col_idade->setAction($order_idade);

        $order_localizacao_geo = new TAction(array($this, 'onReload'));
        $order_localizacao_geo->setParameter('order', 'localizacao_geo');
        $col_local_geo->setAction($order_localizacao_geo);

        // create EDIT action
        $action_view = new TDataGridAction(array('ClassProfileForm', 'onView'), ['register_state' => 'false'] );
